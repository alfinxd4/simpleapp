...
(function (factory) {
	...
	$(document).ready(function () {
		$("#dataTable").dataTable({
			...
			language: {
				paginate: {
					previous: '<i class="fa fa-angle-left" style="color: #000000"></i>',
					next: '<i class="fa fa-angle-right" style="color: #000000"></i>',
				},
			},
		});
	});
	...
	function _fnLanguageCompat(lang) {
		...
		if (lang) {
			...
			if (
				!lang.sEmptyTable &&
				zeroRecords &&
				defaults.sEmptyTable === "Tidak ditemukan data di tabel"
			) {
	...
	DataTable.defaults = {
		...
		oLanguage: {
			 ...
			 *  @type string
			 *  @default Tidak ada data di dalam tabel
			 *
			 *  @dtopt Language
			 ...
			 *
			 *  @type string
			 *  @default Menampilkan _START_ to _END_ of _TOTAL_ entries
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Menampilkan page _PAGE_ of _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			sInfo: "<b> Menampilkan _START_ untuk _END_ dari _TOTAL_ data</b>",
			 ...
			 *    } );
			 */
			sInfoEmpty: "<b>Tidak ada data untuk ditampilkan</b>",
			 ...
			 *    } );
			 */
			sInfoFiltered: "<i>(difilter dari _MAX_ total data)</i>",
			 ...
			 *    } );
			 */
			sZeroRecords: "Tidak ada data di dalam tabel",
		},
